...
interface ImportMetaEnv {
  ...
  readonly DAILY_DOKU_FIREBASE_APP_ID: string;
  readonly DAILY_DOKU_FIREBASE_API_KEY: string;
  readonly DAILY_DOKU_FIREBASE_MESSENGING_SENDER_ID: string;
  readonly DAILY_DOKU_FIREBASE_MEASUREMENT_ID: string;
  [key: string]: any;
}
